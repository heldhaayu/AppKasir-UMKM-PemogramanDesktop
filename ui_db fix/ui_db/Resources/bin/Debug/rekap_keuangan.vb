...
Public Class rekap_keuangan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ui_db.rekap_keuangan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrekap_keuangan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rekap_keuangan = New rekap_keuangan()
        rpt.Site = Me.Site
        Return rpt
    End Function
